  ...
  return (
    <div className={styles.container}>
        ...
        <Container sm gap={0}>
          <div className={styles.heroContent}>
            <div>
              ...
              <Link href="https://github.com/aayushmahapatra/carbonneutral/blob/main/public/carbon-neutral-website-research-paper.pdf" target="_blank">
      ...
      <Container sm gap={0}>
        ...
        <Text size={18} style={{textAlign: "center", maxWidth: 700, margin: "auto", paddingLeft: 10, paddingRight: 10}}>This complete project is open source and licensed under <a href="https://github.com/aayushmahapatra/carbonneutral/blob/main/LICENSE.md" target="_blank" rel="noreferrer"><b>MIT License</b></a>. Feel free to make contributions, send pull requests or fork the current project.</Text>

        <a href="https://github.com/aayushmahapatra/carbonneutral/" className={styles.github} target="_blank" rel="noreferrer"><Image src="/glyphs/github-svgrepo-com.svg" width={20} height={20} alt="github"/> <span>See on GitHub</span></a>
        ...
        {true &&
          <a href="https://github.com/aayushmahapatra/carbonneutral/issues/new" target="_blank" rel="noreferrer">
