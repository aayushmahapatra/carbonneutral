      ...
      <Collapse title="About Calculator Tool">
        <Text style={{fontSize: 18}}>
          ...
          <Text style={{marginBottom: 10, fontSize: 18}}>
            For more details, <Link href="https://github.com/aayushmahapatra/carbonneutral/blob/main/public/carbon-neutral-website-research-paper.pdf" target="_blank" style={{fontWeight: "bold"}}>see the academic paper.</Link>
          </Text>
      </Collapse>
